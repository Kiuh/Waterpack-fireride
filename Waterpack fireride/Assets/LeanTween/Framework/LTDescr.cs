...
public class LTDescr
{
    ...
    {
        return (trans != null ? "name:" + trans.gameObject.name : "gameObject:null")
            + " toggle:"
            + toggle
            + " passed:"
            + passed
    ...
    public LTDescr setRotateAround()
    {
        ...
        easeInternal = () =>
        {
            ...
            Vector3 rotateAroundPt = trans.TransformPoint(_optional.point);
    ...
    public LTDescr setRotateAroundLocal()
    {
        ...
        easeInternal = () =>
        {
            ...
            Vector3 origPos = trans.localPosition;
            trans.RotateAround(
                trans.TransformPoint(_optional.point),
                trans.TransformDirection(_optional.axis),
                -_optional.lastVal
            );
            Vector3 diff = origPos - trans.localPosition;
    ...
    public LTDescr setAlpha()
    {
        ...
        initInternal = () =>
        {
            ...
            {
                if (
                    trans.GetComponent<Renderer>() != null
    ...
    public LTDescr setTextColor()
    {
        ...
        {
            uiText = trans.GetComponent<UnityEngine.UI.Text>();
            _ = setFromColor(uiText != null ? uiText.color : Color.white);
        };
        easeInternal = () =>
        {
            newVect = easeMethod();
    ...
    public LTDescr setCanvasAlpha()
    {
        ...
        initInternal = () =>
        {
            ...
            {
                rawImage = trans.GetComponent<UnityEngine.UI.RawImage>();
                if (rawImage != null)
                {
    ...
    public LTDescr setCanvasColor()
    {
        ...
        initInternal = () =>
        {
            ...
            {
                rawImage = trans.GetComponent<UnityEngine.UI.RawImage>();
                _ = setFromColor(rawImage != null ? rawImage.color : Color.white);
            }
            else
            {
                _ = setFromColor(uiImage.color);
            }
        };
        easeInternal = () =>
        {
    ...
    public LTDescr setCanvasMoveX()
    {
        ...
        easeInternal = () =>
        {
            Vector3 c = rectTransform.anchoredPosition3D;
    ...
    public LTDescr setCanvasRotateAroundLocal()
    {
        ...
        easeInternal = () =>
        {
            ...
            Vector3 origPos = rect.localPosition;
            rect.RotateAround(
                rect.TransformPoint(_optional.point),
                rect.TransformDirection(_optional.axis),
                -val
            );
            Vector3 diff = origPos - rect.localPosition;
    ...
    public LTDescr setRotate()
    {
        ...
        initInternal = () =>
        {
            ...
            to = new Vector3(
                LeanTween.closestRot(fromInternal.x, toInternal.x),
                LeanTween.closestRot(from.y, to.y),
    ...
    public LTDescr setGUIMove()
    {
        ...
        initInternal = () =>
            from = new Vector3(_optional.ltRect.rect.x, _optional.ltRect.rect.y, 0);
        easeInternal = () =>
        {
            Vector3 v = easeMethod();
            _optional.ltRect.rect = new Rect(
                v.x,
                v.y,
                _optional.ltRect.rect.width,
                _optional.ltRect.rect.height
            );
        };
        return this;
    }
    ...
    public LTDescr setGUIScale()
    {
        ...
        initInternal = () =>
            from = new Vector3(_optional.ltRect.rect.width, _optional.ltRect.rect.height, 0);
        easeInternal = () =>
        {
            Vector3 v = easeMethod();
            _optional.ltRect.rect = new Rect(
                _optional.ltRect.rect.x,
                _optional.ltRect.rect.y,
                v.x,
                v.y
            );
        };
    ...
    */
    ...
    public bool updateInternal()
    {
        ...
        if (delay <= 0f && directionLocal != 0f)
        {
            ...
            { // increment or flip tween
                ...
                isTweenFinished = loopCount == 0 || loopType == LeanTweenType.once; // only return true if it is fully complete
    ...
    private static void alphaRecursive(
    ...
    private static void textAlphaChildrenRecursive(
        Transform trans,
        float val,
    ...
    private static Color tweenColor(LTDescr tween, float val)
    {
        ...
        return new Color(
            tween._optional.axis.x + (diff3.x * val),
            tween._optional.axis.y + (diff3.y * val),
            tween._optional.axis.z + (diff3.z * val),
    ...
    */
    public LTDescr setEase(LeanTweenType easeType)
    {
        _ = easeType switch
        {
            LeanTweenType.linear => setEaseLinear(),
            LeanTweenType.easeOutQuad => setEaseOutQuad(),
            LeanTweenType.easeInQuad => setEaseInQuad(),
            LeanTweenType.easeInOutQuad => setEaseInOutQuad(),
            LeanTweenType.easeInCubic => setEaseInCubic(),
            LeanTweenType.easeOutCubic => setEaseOutCubic(),
            LeanTweenType.easeInOutCubic => setEaseInOutCubic(),
            LeanTweenType.easeInQuart => setEaseInQuart(),
            LeanTweenType.easeOutQuart => setEaseOutQuart(),
            LeanTweenType.easeInOutQuart => setEaseInOutQuart(),
            LeanTweenType.easeInQuint => setEaseInQuint(),
            LeanTweenType.easeOutQuint => setEaseOutQuint(),
            LeanTweenType.easeInOutQuint => setEaseInOutQuint(),
            LeanTweenType.easeInSine => setEaseInSine(),
            LeanTweenType.easeOutSine => setEaseOutSine(),
            LeanTweenType.easeInOutSine => setEaseInOutSine(),
            LeanTweenType.easeInExpo => setEaseInExpo(),
            LeanTweenType.easeOutExpo => setEaseOutExpo(),
            LeanTweenType.easeInOutExpo => setEaseInOutExpo(),
            LeanTweenType.easeInCirc => setEaseInCirc(),
            LeanTweenType.easeOutCirc => setEaseOutCirc(),
            LeanTweenType.easeInOutCirc => setEaseInOutCirc(),
            LeanTweenType.easeInBounce => setEaseInBounce(),
            LeanTweenType.easeOutBounce => setEaseOutBounce(),
            LeanTweenType.easeInOutBounce => setEaseInOutBounce(),
            LeanTweenType.easeInBack => setEaseInBack(),
            LeanTweenType.easeOutBack => setEaseOutBack(),
            LeanTweenType.easeInOutBack => setEaseInOutBack(),
            LeanTweenType.easeInElastic => setEaseInElastic(),
            LeanTweenType.easeOutElastic => setEaseOutElastic(),
            LeanTweenType.easeInOutElastic => setEaseInOutElastic(),
            LeanTweenType.punch => setEasePunch(),
            LeanTweenType.easeShake => setEaseShake(),
            LeanTweenType.easeSpring => setEaseSpring(),
            _ => setEaseLinear(),
        };
        return this;
    }
    ...
    {
        return new Vector3(
            from.x + (diff.x * _optional.animationCurve.Evaluate(ratioPassed)),
    ...
    private Vector3 easeInOutQuad()
    {
        ...
        if (val < 1f)
        {
            val *= val;
            return new Vector3(
                (diffDiv2.x * val) + from.x,
                (diffDiv2.y * val) + from.y,
                (diffDiv2.z * val) + from.z
            );
        }
    ...
    private Vector3 easeInSine()
    {
        ...
        return new Vector3(
            (diff.x * val) + diff.x + from.x,
            (diff.y * val) + diff.y + from.y,
    ...
    private Vector3 easeInBounce()
    {
        ...
        val = 1f - val;
        return new Vector3(
            diff.x - LeanTween.easeOutBounce(0, diff.x, val) + from.x,
    ...
    private Vector3 easeInOutBounce()
    {
        ...
        {
            return new Vector3(
                (LeanTween.easeInBounce(0, diff.x, val) * 0.5f) + from.x,
        ...
        else
        {
            val--;
            return new Vector3(
                (LeanTween.easeOutBounce(0, diff.x, val) * 0.5f) + diffDiv2.x + from.x,
    ...
    {
        return new Vector3(
            LeanTween.easeInElastic(from.x, to.x, ratioPassed, overshoot, period),
    ...
    {
        return new Vector3(
            LeanTween.easeOutElastic(from.x, to.x, ratioPassed, overshoot, period),
    ...
    {
        return new Vector3(
            LeanTween.easeInOutElastic(from.x, to.x, ratioPassed, overshoot, period),
    ...
    */
    ...
    {
        float passedTimeRatio = passed / this.time;
    ...
    */
    public LTDescr setRepeat(int repeat)
    {
        loopCount = repeat;
        if (
            (repeat > 1 && loopType == LeanTweenType.once)
            || (repeat < 0 && loopType == LeanTweenType.once)
        )
        {
    ...
    */
    public LTDescr setDirection(float direction)
    {
        ...
        {
            Debug.LogWarning(
                "You have passed an incorrect direction of '"
                    + direction
