...
public class LeanTest : object
{
    ...
    public static void expect(bool didPass, string definition, string failExplaination = null)
    {
        ...
        {
            Debug.Log(
                formatB("Too many tests for a final report!") + " set LeanTest.expected = " + tests
            );
        }
        ...
        {
            timeoutStarted = true;
            GameObject tester = new() { name = "~LeanTest" };
    ...
    public static void overview()
    {
        ...
        Debug.Log(
            formatB("Final Report:")
                + " _____________________ PASSED: "
                + formatBC("" + passes, "green")
                + " FAILED: "
                + failedStr
                + " "
        );
